        ...
        Expanded(
          ...
          child: Container(
              ...
              child: Align(
                alignment: Alignment.centerRight,
                child: Text(
                  "${month.monthTaxeRegion.toStringAsFixed(2).replaceAll(".", ",")}  ",
                  maxLines: 1,
                  softWrap: false,
                  style: const TextStyle(
                    fontSize: 12,
        ...
        Expanded(
          ...
          child: Container(
              ...
              child: Align(
                alignment: Alignment.centerRight,
                child: Text(
                  "${month.monthTotalGlobal.toStringAsFixed(2).replaceAll(".", ",")}  ",
                  maxLines: 1,
                  softWrap: false,
        ...
        Expanded(
          ...
          child: Container(
              ...
              child: Align(
                alignment: Alignment.centerRight,
                child: Text(
                  "${month.monthChargesCommun.toStringAsFixed(2).replaceAll(".", ",")}  ",
                  softWrap: false,
                  style: const TextStyle(
                    fontSize: 12,
                  ),
...
Row decDateNow() {
  return Row(children: [
    SizedBox(width: 10),
    Text(
        "Date d'Etablissement : ${DateFormat('dd/MM/yyyy').format(DateTime.now())}",
    ...
    Expanded(
      child: Table(
        ...
        columnWidths: {
          ...
          1: const FractionColumnWidth(.23),
          2: const FractionColumnWidth(.16),
          3: const FractionColumnWidth(.14),
          4: const FractionColumnWidth(.12),
          5: const FractionColumnWidth(.10),
          6: const FractionColumnWidth(.08),
          7: const FractionColumnWidth(.13),
          8: const FractionColumnWidth(.12),
        },
        children: [
          TableRow(children: [
            Container(
        ...
        children: [
          TableRow(children: [
            ...
            Container(
                ...
                child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text(' ${marin.marinLastName}',
                        softWrap: false,
                        maxLines: 1,
                        style: const TextStyle(
                          fontSize: 11,
